...
function ServicesListContent() {
  ...
  const groupedServices = selectedCategory === "Semua" && !searchQuery
    ? Object.entries(
                ...
                <div key={category}>
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{categoryServices.length} layanan tersedia</p>
                    </div>
                            ...
                            <CardHeader>
                              <div className="flex items-start justify-between gap-4">
                                ...
                                <div className="flex flex-col gap-1 items-end">
                                  {service.category && (
                                    <Badge variant="secondary" className={`text-xs ${colors.bg} ${colors.text} border ${colors.border}`}>
                                      {service.category}
                                    </Badge>
                                  )}
