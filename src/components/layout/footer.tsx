...
const layananPopulerLinks = [
  { title: "Pembuatan KTP-el", href: "/layanan/ktp-el" },
  { title: "Pembuatan Kartu Keluarga", href: "/layanan/kartu-keluarga" },
  { title: "Akta Kelahiran", href: "/layanan/akta-kelahiran" },
  { title: "Pindah Penduduk", href: "/layanan/pindah-penduduk" },
  { title: "Cek Blanko E-KTP", href: "/statistik" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5">
              {layananPopulerLinks.map((link) => (
                <li key={`populer-${link.title}-${link.href}`}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-300 hover:text-green-400 transition-all duration-200 inline-flex items-center gap-1 group relative"
                  >
                    ...
                    <span className="relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-green-400 after:transition-all after:duration-300 group-hover:after:w-full">
                      {link.title}
                    </span>
                  </Link>
                </li>
            ...
            <ul className="space-y-2.5">
              {layananUnggulanLinks.map((link) => (
                <li key={`unggulan-${link.title}-${link.href}`}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-300 hover:text-amber-400 transition-all duration-200 inline-flex items-center gap-1 group relative"
                  >
                    ...
                    <span className="relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-amber-400 after:transition-all after:duration-300 group-hover:after:w-full">
                      {link.title}
                    </span>
                  </Link>
                </li>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5">
              {persyaratanLayananLinks.slice(0, 5).map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-300 hover:text-green-400 transition-all duration-200 inline-flex items-center gap-1 group relative"
        ...
        <div className="pt-8" id="footer-contact">
          ...
          <div className="mt-5 flex items-center gap-3 group cursor-default">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2">
              <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Jam Operasional</span>
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-600 mt-1 flex items-center justify-center gap-1">
                  ...
                  untuk masyarakat Kabupaten Ngada
                </p>
              </div>
            </div>
