        ...
        <section className="py-16 bg-gradient-to-br from-green-600 to-green-800 dark:from-green-800 dark:to-green-950">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-green-100 max-w-xl mx-auto mb-8">
              Hubungi kami melalui telepon, WhatsApp, atau kunjungi langsung kantor Disdukcapil Kabupaten Ngada
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/hubungi-kami"
                className="inline-flex items-center justify-center gap-2 bg-white text-green-700 font-semibold px-8 py-3 rounded-xl hover:bg-green-50 transition-colors"
              >
                Hubungi Kami
              </a>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-green-500 text-white font-semibold px-8 py-3 rounded-xl hover:bg-green-400 transition-colors"
              >
                WhatsApp
              </a>
            </div>
